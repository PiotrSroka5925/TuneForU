            ...
            <div class="row">
                ...
                <div class="col-lg-2 mb-4">
                    ...
                    <ul class="list-unstyled text-lightgray">
                        ...
                        <li class="d-flex align-items-center mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
                            ...
                            </svg><a class="m-0 text-decoration-none text-lightgray footerLink" href="mailto:email@example.com">email@example.com</a></li>
